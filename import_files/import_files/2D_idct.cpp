...
void idct(int16_t DCAC[DCTSIZE][DCTSIZE], uint8_t blockout[DCTSIZE][DCTSIZE])
{
	...
	#pragma HLS ARRAY_RESHAPE variable=blockout_temp type=block factor=4 dim=2 //presume factor of 4 bc 4*8 = 32
...
//			#pragma HLS_PIPELINE
			...
			//ngl, idk if we need this. looked like it worked without reshaping stuff
    }
}
