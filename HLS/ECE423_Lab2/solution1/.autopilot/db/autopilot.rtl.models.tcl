set SynModuleInfo {
  {SRCNAME Loop_VITIS_LOOP_38_1_proc1 MODELNAME Loop_VITIS_LOOP_38_1_proc1 RTLNAME idct_Loop_VITIS_LOOP_38_1_proc1
    SUBMODULES {
  ...
  {SRCNAME Loop_VITIS_LOOP_59_2_proc MODELNAME Loop_VITIS_LOOP_59_2_proc RTLNAME idct_Loop_VITIS_LOOP_59_2_proc
    SUBMODULES {
  ...
  {SRCNAME Loop_VITIS_LOOP_130_3_proc2 MODELNAME Loop_VITIS_LOOP_130_3_proc2 RTLNAME idct_Loop_VITIS_LOOP_130_3_proc2
    SUBMODULES {
  ...
  {SRCNAME idct MODELNAME idct RTLNAME idct IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME idct_workspace_RAM_AUTO_1R1W_memcore RTLNAME idct_workspace_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME idct_workspace_RAM_AUTO_1R1W RTLNAME idct_workspace_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2}
    }
  }
}
