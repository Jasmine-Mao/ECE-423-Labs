set moduleName Loop_VITIS_LOOP_39_1_proc1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Loop_VITIS_LOOP_39_1_proc1}
...
set Spec2ImplPortList { 
	DCAC { axis {  { DCAC_TVALID in_vld 0 1 }  { DCAC_TDATA in_data 0 16 }  { DCAC_TREADY in_acc 1 1 } } }
