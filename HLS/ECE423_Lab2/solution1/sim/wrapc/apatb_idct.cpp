...
#define AUTOTB_TVOUT_DCAC "../tv/cdatafile/c.idct.autotvout_DCAC.dat"
#define AUTOTB_TVIN_blockout "../tv/cdatafile/c.idct.autotvin_blockout.dat"
#define AUTOTB_TVOUT_blockout "../tv/cdatafile/c.idct.autotvout_blockout.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_DCAC "../tv/rtldatafile/rtl.idct.autotvout_DCAC.dat"
#define AUTOTB_TVOUT_PC_blockout "../tv/rtldatafile/rtl.idct.autotvout_blockout.dat"
...
string get_depth_list () {
  ...
  total_list << "{DCAC " << DCAC_depth << "}\n";
  total_list << "{blockout " << blockout_depth << "}\n";
...
extern "C" void idct_hw_stub_wrapper(volatile void *, volatile void *);
    ...
    string AESL_num;
{
      ...
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_DCAC);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            if (AESL_token != "") {
              DCAC_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "DCAC" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
...
((char*)__xlx_apatb_param_DCAC)[j*2+1] = DCAC_pc_buffer[i].range(15, 8).to_int64();
    ...
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_blockout);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            // push token into output port buffer
            if (AESL_token != "") {
              blockout_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "blockout" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
...
idct_hw_stub_wrapper(__xlx_apatb_param_DCAC, __xlx_apatb_param_blockout);
