...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Software/Xilinx/Vitis_HLS/2022.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Software/Xilinx/Vitis_HLS/2022.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Software/Xilinx/Vitis_HLS/2022.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Software/Xilinx/Vitis_HLS/2022.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "idct.autotvin.dat"
	set constFileTvOut       "idct.autotvout.dat"
	set constFileHdlTvIn     "idct.autohdltvin.dat"
	set constFileHdlTvOut    "idct.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
