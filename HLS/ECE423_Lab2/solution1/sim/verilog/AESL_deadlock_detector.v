...
module AESL_deadlock_detector (
    ...
    reg ap_done_reg_1;// for module AESL_inst_idct.Block_idct_for_cond_i_exit_proc2_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_1 <= 'b0;
        end
        else begin
            ap_done_reg_1 <= AESL_inst_idct.Block_idct_for_cond_i_exit_proc2_U0.ap_done & ~AESL_inst_idct.Block_idct_for_cond_i_exit_proc2_U0.ap_continue;
        end
    end
    ...
    // Process: AESL_inst_idct.Block_idct_for_cond_i_exit_proc2_U0
    ...
    assign proc_1_data_PIPO_blk[0] = 1'b0 | (~AESL_inst_idct.DCAC_temp_U.t_empty_n & AESL_inst_idct.Block_idct_for_cond_i_exit_proc2_U0.ap_idle & ~AESL_inst_idct.DCAC_temp_U.i_write);
