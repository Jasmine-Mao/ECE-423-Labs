...
int push(circular_buff_t* buffer/*,insert all the rgb block element types*/){
	// check if full
		// if full, return fail, else continue

	// insert the element at the tail, increment the tail mod by capacity
	return 0;
}
